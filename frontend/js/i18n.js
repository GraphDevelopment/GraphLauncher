...
const I18n = (() => {
  ...
  const LOCALES = {
    ...
    fr: {
      ...
      ws_cat_all: 'Tous', ws_cat_graphique: 'Packs Graphiques', ws_cat_son: 'Packs Son', ws_cat_mods: 'Mods',
    ...
    en: {
      ...
      ws_search_ph: 'Search…',
      ws_cat_all: 'All', ws_cat_graphique: 'Graphic Packs', ws_cat_son: 'Sound Packs', ws_cat_mods: 'Mods',
